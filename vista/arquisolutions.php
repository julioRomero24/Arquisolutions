...
<body id="page-top">
                ...
                <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                    ...
                    <li class="nav-item opc-usuario">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <img id="imagenPerfil" src="img/cerrarsesion.jpg" alt="">
    ...
    <header class="masthead">
        <div class="container">
            <div class="masthead-heading text-uppercase">Arquisolutions</div>
            <div class="masthead-heading text-uppercase"><h5>Los mejores diseños y acabados</h5></div>
                ...
                <div class="col-lg-4 col-sm-6 mb-4">
                    ...
                    <div class="portfolio-item">
                        ...
                        <div class="portfolio-caption">
                            ...
                            <!--<div class="portfolio-caption-subheading text-muted">no se que poner</div>-->
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6 mb-4">
                    ...
                    <div class="portfolio-item">
                        ...
                        <div class="portfolio-caption">
                           ...
                           <!--- <div class="portfolio-caption-subheading text-muted">y mantenimiento</div>-->
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6 mb-4">
    ...
    <section id="about">
        <div class="container px-4">
            <div class="row gx-4 justify-content-center">
                <div class="col-lg-8">
                    <h2>Arquisolutions</h2>
                    <p class="lead">Es una Empresa orgullosamente Colombiana especializada en el diseño, la construcción, acabados arquitectónicos y servicios generales; que ofrece además una exclusiva asistencia para todos aquellos clientes interesados en un trato personalizado, que abarca todo tipo de proyectos, siempre guiados por nuestra filosofía de máxima calidad e innovación. Fue constituida como empresa dedicada a la actividad constructora. La idea nació del Arquitecto FABIAN CAMARGO ROMERO, quien en su afán por la formulación de nuevas propuestas constructivas e identificando las verdaderas necesidades de sus clientes toma la decisión de fundar dicha Empresa, la cual esta cimentada por una amplia y variada experiencia en el campo de la construcción, como es la que posee el arquitecto fundador de más de doce (12) años de trayectoria profesional.</p>
    ...
    <section class="page-section" id="about">
        <div class="container">
            ...
            <div id=Nosotros>
                <p>
                    Es una Empresa orgullosamente Colombiana especializada en el diseño, la construcción, acabados arquitectónicos y servicios generales; que ofrece además una exclusiva asistencia para todos aquellos clientes interesados en un trato personalizado, que abarca todo tipo de proyectos, siempre guiados por nuestra filosofía de máxima calidad e innovación. Fue constituida como empresa dedicada a la actividad constructora. La idea nació del Arquitecto FABIAN CAMARGO ROMERO, quien en su afán por la formulación de nuevas propuestas constructivas e identificando las verdaderas necesidades de sus clientes toma la decisión de fundar dicha Empresa, la cual esta cimentada por una amplia y variada experiencia en el campo de la construcción, como es la que posee el arquitecto fundador de más de doce (12) años de trayectoria profesional.
                </p>
            </div>
             <ul class="timeline">
                <li>
